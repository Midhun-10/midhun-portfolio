...
const projects = [
  {
    index: '01',
    title: 'Taste Good -Food Ordering Application',
    ...
    bullets: [
      'Architected a layered Spring Boot backend (Controller, Service, Repository, DTO). ',
      'Exposing 12+ RESTful API endpoints with Global Exception Handling and ResponseEntity for secure, consistent responses.',
      'Built a dynamic React.js frontend with 8 reusable components and BrowserRouter for seamless client-side routing and real-time UI state management.',
      'Deployed full application to production: Spring Boot backend on Railway, React frontend on Netlify, and MySQL database hosted on Clever Cloud.',
    ],
    tags: ['React Js', 'Spring boot', 'Java Core', 'Mysql', 'Hibernate','GitHub','netlify','render','clever cloud'],
    link: 'https://taste-cool.netlify.app',
    linkLabel: 'Live Demo',
    linkIcon: 'external',
  },
  {
